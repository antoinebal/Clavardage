...
public class Connecte implements ActionListener, MouseListener, KeyListener {
	...
	public void initialize() {
		...
		frmConnecte.addWindowListener(new WindowAdapter(){
		    @Override
		    public void windowClosing(WindowEvent e) //Permet de fermer proprement l'application (fermeture sockets et base de donn�e)
		    {
		...
		btnChangerDePseudo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
			    ...
			    String testnewpseudo = jop.showInputDialog(null, "Votre nouveau pseudo ? (Pas d'accent, de \":\", de \";\" ni un d�j� existant)" , "Changer pseudo", JOptionPane.QUESTION_MESSAGE);
			    ...
			    if (testnewpseudo.contains(":") || testnewpseudo.contains(";") ||  testnewpseudo.contains("ê")||  testnewpseudo.contains("�")|| testnewpseudo.contains("�")|| testnewpseudo.contains("�")|| testnewpseudo.contains("�") || testnewpseudo.isEmpty() || existedeja) {
			    }
			    else {
			    	login=testnewpseudo;
